...
def resnet18(args):
    ...
    """
    model = ResNet(BasicBlock, [2, 2, 2, 2], num_classeses=args.num_classes, num_neurons=args.num_neurons)
    if args.pretrained:
...
def resnet34(args):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, [3, 4, 6, 3], num_classeses=args.num_classes, num_neurons=args.num_neurons)
    if args.pretrained:
        model_dict = model.state_dict()
